    ...
    methods: {
        ...
        submitForm() {
            this.$refs['form'].validate((valid) => {
                if (valid) {
                    // 调用新增接口
                    axios.post('/api/device/edit', this.form)
                        .then(response => {
