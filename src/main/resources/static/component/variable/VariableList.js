Vue.component('variable-list', {
    ...
    template: `
    <div class="component">
        <div class="title"><span style="color: #a1a0a0;">变量管理<i style="margin: 0 10px" class="el-icon-arrow-right"></i></span>变量列表</div>
        <el-row class="nav" :gutter="20">
          <el-col :span="3" class="nav-title">变量列表</el-col>
          <el-col :offset="12" :span="9" class="nav-right">
            <el-button size="mini" type="primary" @click="handleCreate">添加变量</el-button>
        ...
        <div class="search-container">
            <el-input v-model="variable.variableName" class="search-item" clearable size="small" placeholder="请输入变量名称"></el-input>
            <el-input v-model="variable.variableCode" class="search-item" clearable size="small" placeholder="请输入变量编码"></el-input>
            <el-select v-model="variable.templateId"  class="search-item" filterable clearable size="small" placeholder="请选择模板" @change="changeTemplate">
                <el-option
            ...
            <el-select v-model="variable.messageId"  class="search-item" filterable clearable size="small" placeholder="请选择报文">
                <el-option
        ...
        <el-pagination
            ...
            :current-page="variable.pageNum"
            :page-sizes="[10, 20, 50]"
            :page-size="variable.pageSize"
    ...
    methods: {
        ...
        async queryPageList() {
            try {
                ...
                this.variable.total = response.data.data.total
            } catch (error) {
        ...
        async getMessageOptions() {
            try {
                const response = await axios.get("/api/message/getList",{
                    params: { templateId: this.variable.templateId }
                });
        ...
        handleBatchDelete() {
            ...
            this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                ...
                // 调用删除接口
                axios.post('/api/variable/batchDelete', this.multipleSelection)
                    .then(response => {
        ...
        handleCurrentChange(val) {
            this.variable.pageNum = val
            this.queryPageList()
        },
        // 分页插件事件
        handleSizeChange(val) {
            this.variable.pageSize = val
            this.variable.pageNum = 1
            this.queryPageList()
        },
        // 表格多选框
